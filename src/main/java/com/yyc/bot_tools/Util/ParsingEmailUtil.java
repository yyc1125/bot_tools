...
public class ParsingEmailUtil {
     ...
     * @throws Exception
     */
    public static ArrayList resceive(String emailAdress, String password) throws Exception {
...
//        System.out.println("新邮件: " + folder.getNewMessageCount());
        ...
        //解析邮件
        ArrayList arrayList = parseMessage(messages);
...
//        deleteMessage(messages);
     ...
     */
    public static ArrayList parseMessage(Message... messages) throws MessagingException, IOException {
...
//                }
                ...
                //匹配查找礼卡
                String regCard = "\\*Card #:\\* (\\d{16})";
                String regPin = "\\*PIN:\\* (\\d{8})";
                Pattern compileCard = Pattern.compile(regCard);
                Pattern compilePin = Pattern.compile(regPin);
                Matcher matcherCard = compileCard.matcher(s);
                Matcher matcherPin = compilePin.matcher(s);
                JSONObject jsonObject = new JSONObject();
                while (matcherCard.find()){
                    jsonObject.put("card",matcherCard.group(1));
                }
                while (matcherPin.find()){
